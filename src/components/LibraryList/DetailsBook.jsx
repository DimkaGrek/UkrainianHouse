...
export const DetailsBook = ({
  ...
  return (
    <div
      className="flex justify-center  items-start gap-[25px] relative
      
        "
    >
      {/* // lg:w-[989px] lg:h-[571px]lg:pr-[100px]  lg:pl-[100px] */}
      <div className="items-start md:pr-[205px] lg:pr-[415px] ">
        <div className="flex gap-[10px] ">
          <img
            className=" w-[91px] h-[148px] mb-[16px] w-[163px] h-[260px]  rounded-[18px]   
...
font-istok  md:text-[16px] md:leading-[1.375] md:mb-[8px]
       ...
       lg:h-[462px]
        ...
        <Icon
          name="heart"
          size={65}
          className=" absolute size-[35px] right-[20px] md:size-[65px] md:top-[-20px] md:right-[50px]  lg:top-[90px] lg:right-[43%]  fill-[#daefff]"
          viewbox="36"
        />
      </div>
    </div>
