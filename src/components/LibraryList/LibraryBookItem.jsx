...
export const LibraryBookItem = ({
  ...
  return (
    ...
    <>
      <div
        onClick={toggleModal}
        className=" shadow-lg p-1 lg:p-4 rounded-[18px] group w-full lg:w-[260px] transition duration-300  
  border border-transparent 
    active:bg-my-lightblue hover:bg-my-lightblue focus-visible:bg-my-lightblue cursor-pointer  "
      >
        ...
        <h4 className="line-clamp-1 mb-[4px] text-[18px] leading-[1] text-[#1e1e1e] font-istok text-center lg:text-[28px] lg:leading-[1.28571] transition duration-300">
          {author}
        </h4>
        <ul className="pt-0 pl-2 pr-2 pb-2 ">
          <li>
            <p
              className="line-clamp-1 mb-[4px] font-proza font-semibold text-[20px] leading-[1.2] text-center text-[#1e1e1e]
             lg:font-semibold lg:leading-[1.6]"
            >
              {title}
            </p>
          </li>
          <li>
            <p className="line-clamp-1 font-istok  text-[12px] leading-[1.5] text-center text-[#666] lg:italic lg:text-[20px] lg:leading-normal lg:text-start">
              {genre}
            </p>
          </li>
          <li>
            <p
              className="font-istok  text-[14px] leading-[1.28571] text-[#666666] flex justify-between items-center 
             lg:italic  lg:text-[20px] lg:leading-normal lg:text-[#1e1e1e]"
            >
              {pageCount} pages
