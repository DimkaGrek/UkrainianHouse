      ...
      >
        <div className="overflow-hidden rounded-[18px] mb-[14px] lg:mb-[18px] group-active:text-[#fbfbfb] group-hover:text-[#fbfbfb] group-focus-visible:text-[#fbfbfb] transition duration-300">
          <img
            ...
            src={
              item.photoUrls[0]
                ? `http://dev.ukrhouse.pp.ua:8080/${item.photoUrls[0].photoUrls}`
                : ''
            }
        ...
        <div className="mb-[16px]">
          <h3 className="font-proza-medium font-medium text-[20px] text-[#1a1a1a] leading-[120%] mb-[8px] lg:text-[26px] lg:leading-[131%] group-active:text-[#fbfbfb] group-hover:text-[#fbfbfb] group-focus-visible:text-[#fbfbfb] ">
            {item.title}
          </h3>
          <p className="font-istok text-[14px] text-[#393939] leading-[129%] lg:text-[16px] lg:leading-[137%] line-clamp-5 lg:line-clamp-3 group-active:text-[#e4e4e4] group-hover:text-[#e4e4e4] group-focus-visible:text-[#e4e4e4]">
            {item.content}
          </p>
        </div>
        <div className="flex justify-between font-istok text-[12px] text-[#a6a6a6] leading-[150%] group-active:text-[##dbdbdb] group-hover:text-[##dbdbdb] group-focus-visible:text-[##dbdbdb] mt-auto">
