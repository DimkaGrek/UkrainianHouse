  ...
  return (
    <div className="relative help-modal">
      <Icon
        name="heart"
        size={60}
        className="hidden lg:block absolute lg:-top-[130px] lg:-left-[65px] fill-[#f4faff] -rotate-45"
        viewbox="36"
      />
      ...
      <button
        type="button"
        className="w-full lg:w-[160px] rounded-[10px] h-[44px] lg:h-[52px] border border-[#1e1e1e] py-[10px] lg:py-[9px] text-[16px] lg:text-[20px] text-[#1e1e1e] text-center leading-[1] font-bold"
        onClick={toggleModal}
      >
        Sounds good
      </button>
