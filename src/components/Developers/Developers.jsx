...
export const Developers = () => {
  ...
  return (
    <>
      ...
      <div className="carousel carousel-vertical h-[315px] md:flex-row md:carousel-center md:h-[380px] md:space-x-[44px] sm-max:h-[290px] md:w-full lg:flex-wrap lg:gap-x-[44px] lg:gap-y-0 lg:space-x-0 lg:h-full">
