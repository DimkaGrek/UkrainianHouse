...
const authSlice = createSlice({
  ...
  extraReducers: (builder) =>
    builder
      ...
      .addMatcher(isAnyOf(loginThunk.rejected, logoutThunk.rejected), (state, { payload }) => {
...
export const { selectToken, selectIsLoggedIn, selectIsRefreshing, selectIsLoading, selectIsError } =
  authSlice.selectors;
